...
class WSUWP_Admission_Info_Form_Shortcode {
	...
	public function __construct() {
		add_shortcode( 'wsu_admission_info_form', array( $this, 'display_wsu_admission_info_form' ) );
	}

	/**
	 * Displays the request for information form.
	 */
	public function display_wsu_admission_info_form() {
		wp_enqueue_script( 'info_form', get_stylesheet_directory_uri() . '/js/info-form.min.js', array( 'jquery' ), '', true );
...
new WSUWP_Admission_Info_Form_Shortcode();
